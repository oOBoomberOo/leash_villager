...
tag @s add boomber.leash_villager.target
	execute as @e[type=#boomber:leash_villager/leashable, distance=..5.5, limit=1, sort=nearest, tag=!global.ignore] at @s run function boomber:leash_villager/villager/leash
